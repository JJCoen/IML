...
These answer questions related to individual predictions.  Plots are generated for specific applicants showing feature influence in terms of log(Odds of default) compared to the average log odds across all applicants.  Figure \@ref(fig:type1) shows plots for two individual applicants.  

```{r type1, fig.cap="Sign and Magnitude of Feature Influence", out.width="1.0\\linewidth", fig.align="center"}
knitr::include_graphics(path = "images/QII-type-1.png", error = FALSE)
```
